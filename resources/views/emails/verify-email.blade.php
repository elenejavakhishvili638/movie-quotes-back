    ...
    <div style='width:100%'>
        ...
        <div style="margin-top:73px;align-text:left;">
            {{-- <div style="margin-bottom:40px">
                <p
                    style="margin-bottom:16px;width:max-content;margin:0 auto;font-style:normal;font-weight:900;font-size:25px;line-height:30px;text-align:center;color:#000">
                    Confirmation Email</p>
                <p style="font-size:18px;line-height:22px;text-align:center;color:#000;width:max-content;margin:0 auto">
